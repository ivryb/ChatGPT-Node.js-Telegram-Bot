...
trial-ended = 
  Використання OpenAI API, завдяки якому цей бот функціонує, нажаль, не безкоштовне. Втім, завдяки цьому бот генерує відповіді значно швидше, ніж безкоштовний сайт, і вам <b>не треба</b> купляти офіційну підписку OpenAI вартістю <b>$20/місяць</b>.
